...
const AddDiscountPromotion = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (isValid && isRangeValid && isRangeValueValid) {
      ...
      if (response) {
        success(promotionCampaignToast.rewardAdded);
      ...
      <Row className="mb-5">
        <Col sm>
          <h1 className="fs-22 fw-bolder">
            {PromotionAndCampaignString.addReward}
          </h1>
        </Col>
      </Row>
      <Row>
                        ...
                        <Col xs={8}>
                          <CustomDatePicker
                            ...
                            customInput={
                              <CustomDateInput
                                inputClass={`${
                                  validations.startDate ? 'border-danger' : ''
                                }`}
                              />
                            }
                            //    isClearable={true}
                      ...
                      <Row className="align-items-center">
                        ...
                        <Col xs={8}>
                          <CustomDatePicker
                            ...
                            dateFormat="dd/MM/yyyy"
                            showFullMonthYearPicker
                            minDate={rewardData?.startDate || new Date()}
                            inputTextBG="bg-white"
                            showYearDropdown={true}
                            scrollableYearDropdown={true}
                            dropdownMode="select"
                      ...
                      {rewardData.purchaseRange.map((item, index) => {
                        return (
                          <Row className="mb-3">
                            ...
                            >
                              {index === rewardData.purchaseRange.length - 1 ? (
                                <Button
                                  variant="link"
                                  className="btn-flush"
                                  onClick={() => {
                    ...
                    <div className="d-flex flex-wrap mb-6 gap-2 mt-2 align-items-center">
                      ...
                      <div className="form-check me-4 d-flex align-items-center ">
                        <input
                          ...
                          checked={
                            rewardData.placement === ProductPlacement.toString()
                          }
                          onChange={(event) =>
                            handleChange(event.target.value + '', 'placement')
                          }
                      ...
                      <div className="form-check me-4 d-flex align-items-center ">
                        <input
                          ...
                          checked={
                            rewardData.placement === BrandPlacement.toString()
                          }
                          onChange={(event) =>
                            handleChange(event.target.value + '', 'placement')
                          }
