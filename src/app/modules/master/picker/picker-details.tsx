...
import PickerTabBasicDetails from './picker-tab-basic-details';
import PickerTabHistory from './picker-tab-history';
import APICallService from '../../../../api/apiCallService';
import { pickerEndPoints } from '../../../../api/apiEndPoints';
...
const PickerDetails = () => {
  ...
  const [stateData, setStateData] = useState<any>(location.state);
  ...
  const [tab, setTab] = useState([
    {
      name: 'Basic details',
      content: <PickerTabBasicDetails basicDetails={userDetails} />,
      value: '1',
    },
    // {
  ...
  useEffect(() => {
    (async () => {
      ...
      updateOptionWithPermission();
      setLoading(true);
      await fetchPickerInfo(stateData);
  ...
  const fetchPickerInfo = async (id: any) => {
    ...
    if (response) {
      ...
      setCurrentTab({
        name: 'Basic details',
        content: <PickerTabBasicDetails basicDetails={response} />,
        value: '1',
      });
    }
  };
    ...
    <>
      ...
      <>
        ...
        <Row className="mb-7 align-items-center">
          <Col md>
            <h1 className="fs-22 fw-bolder mb-md-0 mb-3">{'Picker details'}</h1>
          </Col>
          {!loading && (
            <Col sm="auto">
              <div className="d-inline-flex">
                <div className="my-0 pe-2">
                  ...
                  Method.hasPermission(PickerConst, Delete, currentUser) ? (
                    <CustomSelectTable
                      marginLeft={'-110px'}
                      width={'auto'}
                      placeholder={
                        ...
                        <div className="d-flex flex-column mb-2">
                          ...
                          <div className="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            <div className="d-flex align-items-center text-black fs-16 fw-500 me-5 mb-2">
                              ...
                              {userDetails?.phoneCountry +
                                ' ' +
                                userDetails?.phone}
                              {/* {String.countryCode + ' ' + '9988774455'} */}
                            </div>
