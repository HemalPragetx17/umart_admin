...
import { AllRecipesConst } from '../../../../utils/constants';
const Ingredients = (props: any) => {
  ...
  const fetchProductList = async (category: any, subCategory: any,index:number) => {
  ...
  return (
    <>
                        ...
                        <Col lg={8}>
                          <CustomSelectWhite
                            ...
                            value={
                              ...
                              props?.primaryCategory.find((val: any) => {
                                return val._id === item.category;
                              })
                                ? props?.primaryCategory.find((val: any) => {
                                    return val._id === item.category;
                                  })
      ...
      <div>
        <div
          className="text-primary fs-16 fw-bolder cursor-pointer"
