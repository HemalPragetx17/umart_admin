...
import { Download, GeographicSalesInsightReport } from '../../../../utils/constants';
  ...
  const handleDownload = async () => {
    ...
    if (response) {
      ...
      downloadLink.download =
        'Geographic_Sales_Insights_Report' +
            ...
            <table className="table table-row-bordered datatable align-middle gs-7 gy-4 my-0">
              <thead>
                <tr className="fs-16 fw-600 h-65px align-middle">
                  ...
                  <th className="min-w-150px">Area</th>
                  <th className="min-w-600px">Top Products Purchased</th>
                </tr>
              </thead>
              <tbody className="fs-15 fw-600">
                {fetchLoading ? (
                  ...
                  <>
                    {salesData.length ? (
                      <>
                        {salesData?.map((val: any, index: number) => (
                          <>
                            <tr key={index}>
                              <td>
                              ...
                              <td>
                                <span className="fs-15 fw-600">
                                  {val.topProducts.map((item: any) => item)[0]}
                                </span>
                              </td>
                            </tr>
                            {val.topProducts.length > 1 ? (
                              <>
                                {val.topProducts?.map(
...
export default GeographicSalesInsight;
