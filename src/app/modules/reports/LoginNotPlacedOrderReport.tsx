...
const LoginNotPlacedOrderReport = () => {
  ...
  const handleDownload = async () => {
    ...
    if (response) {
      ...
      link.href = url;
      link.download = 'customer-not-placed-order-report' + '.xlsx';
      link.click();
  ...
  return (
    <Row>
      <Col>
        <h1>Login & not placed order report</h1>
      </Col>
      <Col md="auto">
        <Button
...
export default LoginNotPlacedOrderReport;
