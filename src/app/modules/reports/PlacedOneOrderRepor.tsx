...
const PlacedOneOrderReport = () => {
  ...
  const handleDownload = async () => {
    ...
    if (response) {
      ...
      link.href = url;
      link.download = 'placed-one-order-report' + '.xlsx';
      link.click();
...
export default PlacedOneOrderReport;
