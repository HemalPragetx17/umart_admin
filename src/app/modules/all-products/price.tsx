...
const Price = (props: any) => {
  ...
  const [prices, setPrices] = useState<any>(
    props.generalData.combinations.map((item: any) => {
      return {
        price: '',
      };
    })
  ...
  const handleChange = async (
    ...
    if (name === 'price') {
      ...
      if (Validations.allowNumberAndFloat(value)) {
        ...
        const formattedValue: any = Method.getGeneralizedAmount(value);
      ...
      temp.combinations[combinationIndex].units[name] = value.toUpperCase();
  ...
  const checkValidation = async (
    ...
    if (name === 'price') {
      ...
      if (
        ...
        tempValidation.combinations[combinationIndex].units[name][
          itemIndex
        ] = true;
      } else {
        tempValidation.combinations[combinationIndex].units[name][
                                        ...
                                        <div className="input-group input-group-solid h-60px border">
                                          <span
                                            className={clsx(
                                              ...
                                              generalDataValidation
                                                .combinations[index].units.price
